...
let db;
// establish a connection to IndexedDB database called 'pizza_hunt' an const request = indexedDB.open('pizza_hunt', 1);

const request = indexedDB.open('myaccount_mgmt', 1);
